// $Id: SGObjects_T.h 160 2007-06-22 15:21:10Z mburo $
...
template <class TPosition, class TMatchType>
void CSGGame<TPosition, TMatchType>::CalcPos(CSGGame<TPosition, TMatchType>::TPosition& posCalc, u4 nMoves) const {
  if (nMoves>ml.size())
		nMoves=ml.size();
	posCalc=posStart;
